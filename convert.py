...
<head>
    ...
    <meta property="og:url" content="https://fukukei23.github.io/ai-trending-guide/chapters/{{ slug }}.html">
...
<body>
    <header class="site-header">
        ...
        <a href="../index.html" class="site-title">⚡ AI Trending Watch</a>
    ...
    <footer class="site-footer">
        <p>AI Trending Watch — <a href="https://github.com/fukukei23/ai-trending-guide">GitHub</a>
...
<body class="index-page">
    <header class="site-header">
        <span class="site-title">⚡ AI Trending Watch</span>
        <button class="theme-toggle" id="themeToggle" aria-label="テーマ切替">
            <span class="icon-light">☀️</span>
            <span class="icon-dark">🌙</span>
        </button>
